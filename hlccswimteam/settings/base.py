# Django settings for hlccswimteam project.
...
# ** however this is a swimtheme app so we're using the default settings.
# ** Don't use this key in any non-swimtheme usage!
...
WSGI_APPLICATION = 'hlccswimteam.wsgi.application'
...
EMAIL_SUBJECT_PREFIX = '[hlccswimteam] '
...
WAGTAIL_SITE_NAME = 'hlccswimteam'
